...
var lastOne=document.querySelector(".arrow_left");
var nextOne=document.querySelector(".arrow_right");
...
/********************************************begin************************************/
/*Code Here*/
document.write("<style> body{ background-color: aliceblue;text-align:center;} #bd{margin:0 auto; padding:20px 0 20px 0 ;width: 700px; background-color: gainsboro;} h3{display: none;}  table{width:600px; margin:25px auto 5px auto; font-weight: bold;  table-layout:fixed;  border-radius:10px;}</style>");
...
var intervalId;
function play() {
    intervalId=setInterval(nextOnePic,2000);
}
container.addEventListener("mouseover",function () {clearInterval(intervalId);
})
container.addEventListener("mouseout",function () {play();
})
play();
/*********************************************end*************************************/
